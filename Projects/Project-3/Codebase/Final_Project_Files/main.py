...
# EID Project-3 Main Python Script
...
# AWS Message Formatting and Sending
def AWS_Format_Send_Message(Msg_Type):
    ...
    global AWS_QoS, AWS_Data_Type, AWS_Alert_Type, AWS_Data_Type_String, AWS_Alert_Type_String, AWS_Msg_ID
    ...
    # To see if the message is of Data or Alert type
    ...
    if((Humidity_Data != None) and (Temperature_Data != None)):
        ...
        if((Thr_Res.TH_Flag == Alert_Asserted) or \
           ...
           (Thr_Res.HL_Flag == Alert_Asserted)):
            ...
            # If it is alert, send Alert message
            ...
            # If no alert, then send normal data message
